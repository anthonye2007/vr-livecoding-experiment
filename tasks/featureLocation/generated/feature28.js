...
paddle9.position.x -= -0.19999999999999996;
paddle9.position.z -= 2.0;
paddle9.material.color.setStyle('blue');
scene.add(paddle9);

var paddle10 = makePaddle();
paddle10.name = 'paddle10';
paddle10.position.x = -2.5;
...
paddle11.position.x -= -0.5;
paddle11.position.z += 3.7;
