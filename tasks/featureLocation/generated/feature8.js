...
paddle1.position.x += -0.19999999999999996;
paddle1.position.z += 2.9;
paddle1.material.color.setStyle('blue');
scene.add(paddle1);

var paddle2 = makePaddle();
paddle2.name = 'paddle2';
paddle2.position.x += 1.2;
paddle2.position.z = 1.5;
...
paddle5.position.x -= 1.5;
paddle5.position.z -= 2.6;
...
paddle11.position.x = 2.8;
paddle11.position.z -= 1.2;
