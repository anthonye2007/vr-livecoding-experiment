...
paddle8.position.x -= 0.3;
paddle8.position.z = 2.1;
paddle8.material.color.setStyle('blue');
scene.add(paddle8);

var paddle9 = makePaddle();
paddle9.name = 'paddle9';
paddle9.position.x -= 0.5;
paddle9.position.z -= 2.5;
...
paddle12.position.x = 1.7;
paddle12.position.z += 3.6;
