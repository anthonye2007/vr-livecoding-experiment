...
paddle7.position.x -= -2.2;
paddle7.position.z -= 3.1;
paddle7.material.color.setStyle('blue');
scene.add(paddle7);

var paddle8 = makePaddle();
paddle8.name = 'paddle8';
paddle8.position.x += -0.6;
paddle8.position.z -= 0.6;
